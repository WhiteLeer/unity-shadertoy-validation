# 4d2yRt (SynTech 001) 原理解析

## 1. 效果类型
- 这是一个 Shadertoy 程序化效果（pass 数：4）。
- 作者：KK
- 目标分辨率：1024x576
...
- pass0 channel1: buffer /media/previz/buffer02.png
- pass0 channel2: musicstream https://soundcloud.com/ajna-goa/ajna-search-of-the-divine
- pass2 channel0: buffer /media/previz/buffer00.png
- pass3 channel0: buffer /media/previz/buffer01.png
