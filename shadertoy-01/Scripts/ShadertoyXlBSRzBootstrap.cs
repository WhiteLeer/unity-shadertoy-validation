...
public class ShadertoyXlBSRzBootstrap : ShadertoyBootstrapBase
{
    ...
    protected override string DefaultResolutionJsonRelativePath => "unity-shadertoy-validation/shadertoy-01/shadertoy-1-capture.resolution.json";
    ...
    private void OnValidate()
    {
        if (channel0Texture == null)
        {
            channel0Texture = AssetDatabase.LoadAssetAtPath<Texture2D>(
                "Assets/unity-shadertoy-validation/shadertoy-01/Textures/0a40562379b63dfb89227e6d172f39fdce9022cba76623f1054a2c83d6c0ba5d.png"
            );
        }
    }
#endif
