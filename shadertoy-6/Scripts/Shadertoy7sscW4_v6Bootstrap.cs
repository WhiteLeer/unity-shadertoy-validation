...
public class Shadertoy7sscW4_v6Bootstrap : ShadertoyBootstrapBase
{
    ...
    protected override string DefaultResolutionJsonRelativePath => "unity-shadertoy-validation/shadertoy-6/shadertoy-6-capture.resolution.json";
    ...
    private void OnValidate()
    {
        if (channel0Cubemap == null)
        {
            channel0Cubemap = AssetDatabase.LoadAssetAtPath<Cubemap>(
                "Assets/unity-shadertoy-validation/shadertoy-6/Textures/793a105653fbdadabdc1325ca08675e1ce48ae5f12e37973829c87bea4be3232.png"
            );
        }
    }
#endif
