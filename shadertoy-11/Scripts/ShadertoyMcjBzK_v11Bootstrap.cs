...
public class ShadertoyMcjBzK_v11Bootstrap : ShadertoyBootstrapBase
{
    ...
    protected override string TargetShaderAssetPath => "Assets/unity-shadertoy-validation/shadertoy-11/Shaders/shadertoy-McjBzK.shader";
    ...
    private void OnValidate()
    {
        if (channel0Texture == null)
            channel0Texture = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/unity-shadertoy-validation/shadertoy-11/Textures/8de3a3924cb95bd0e95a443fff0326c869f9d4979cd1d5b6e94e2a01f5be53e9.jpg");
    }
#endif
