...
public class Shadertoy4d2yRt_v10Bootstrap : MonoBehaviour
{
    ...
    private const string ResolutionPath = "unity-shadertoy-validation/shadertoy-10/shadertoy-10-capture.resolution.json";
