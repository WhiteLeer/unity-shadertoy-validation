...
public class Shadertoy4dXGR4Bootstrap : ShadertoyBootstrapBase
{
    ...
    protected override string DefaultResolutionJsonRelativePath => "unity-shadertoy-validation/shadertoy-00/shadertoy-0-capture.resolution.json";
    ...
    private void OnValidate()
    {
        if (channel0Texture == null)
        {
            channel0Texture = AssetDatabase.LoadAssetAtPath<Texture2D>(
                "Assets/unity-shadertoy-validation/shadertoy-00/Textures/92d7758c402f0927011ca8d0a7e40251439fba3a1dac26f5b8b62026323501aa.jpg"
            );
        }
        ...
        if (channel1Clip == null)
        {
            channel1Clip = AssetDatabase.LoadAssetAtPath<AudioClip>(
                "Assets/unity-shadertoy-validation/shadertoy-00/Audio/3c33c415862bb7964d256f4749408247da6596f2167dca2c86cc38f83c244aa6.mp3"
            );
        }
    }
#endif
