# Wf3cz7 (Fork Simple dis yufengjie 452) 原理解析

## 1. 效果类型
- 这是一个 Shadertoy 程序化效果（pass 数：1）。
- 作者：yufengjie
- 目标分辨率：512x288
...
## 5. 输入通道
- pass0 channel0: texture /media/a/08b42b43ae9d3c0605da11d0eac86618ea888e62cdd9518ee8b9097488b31560.png
