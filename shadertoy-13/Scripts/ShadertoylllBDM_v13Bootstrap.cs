...
public class ShadertoylllBDM_v13Bootstrap : MonoBehaviour
{
    ...
    private const string ResolutionPath = "unity-shadertoy-validation/shadertoy-13/shadertoy-13-capture.resolution.json";
