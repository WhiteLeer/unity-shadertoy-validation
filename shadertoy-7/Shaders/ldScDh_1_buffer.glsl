...
float fbm4( in vec2 p ) { return fbm(p,4); }
float fbm4( in vec3 p ) { return fbm(p,4); }
float fbm6( in vec2 p ) { return fbm(p,6); }
float fbm6( in vec3 p ) { return fbm(p,6); }
